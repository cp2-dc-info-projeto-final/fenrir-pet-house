...
<html lang="pt-br">
  ...
  <body>
    ...
    <div class="fenrir-login">
        <h1>Servicos</h1>
        <p><strong>Altera Serviço</strong></p>
        <form action="altagendamento2.php" method="POST">
            <input type="hidden" name="operacao" value="buscar">
            <p>Email do cliente: <input type="text" name="email" size="15"> </p><br>
            <p>Descrição: <input type="text" name="desc" size="15"> </p><br>
